...
signup,googleSignupBtn.addEventListener("click",(e)=>{
    e.preventDefault();
    // let name = signupform.uname.value;
    // let email = signupform.email.value;
    // let password = signupform.psw.value;
    signupbtn.style.display = "none";
    alert("You have successfully signup");
    write.innerText = "account_circle";
    write.style.fontsize = "2rem";
    write.id = "profile";
...
jumpLogin.addEventListener("click", function () {
    signupbtn.style.display = "none";
    loginbtn.style.display = "block";
})
signback.addEventListener("click",function(){
    loginbtn.style.display = "none";
    signupbtn.style.display = "block";
})
...
let codingblogs = [{
    Name:"Java Constructor",topictext:"This is a blog on java constructor",author:"~ Simran",text:`In this Java tutorial, we are going to discuss everything that you must know about a Constructor in Java. Constructor in Java is a block of code that creates an object. We can also call it an Object Builder.They are similar to methods in Java but they differ from methods in the fact that they do not have a return type like methods.
...
let travelblogs = [{
    Name:"Travel Blog1",text:"I love travelling.... read this blog to know my journey",author:" ~ Komal"
}]

let foodblogs = [{
    Name:"Burger",text:"My yummy experience of burgers on various places",author:"~ Harshit"
},{Name:"Chilli Potato",text:"Let's see whats happens when I ate chilli potato first time",author:"~ Sushmita Ray"}]
...
mainHead.addEventListener("click",function(){
    ...
    <div class="left-side"><img src="/Blogging Website/Images/coding.jpg"></div>
    <div class="right-side">
        <div class="image"><img src="/Blogging Website/Images/travel.jpg"></div>
        <div class="image"><img src="/Blogging Website/Images/food.jpg"></div>
    </div>
</div>
<div class="quotes">
    "${str}
